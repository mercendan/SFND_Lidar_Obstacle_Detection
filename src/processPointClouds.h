...
public:
    ...
    typename pcl::PointCloud<PointT>::Ptr CreateVectorToPointCloudData(std::vector<std::vector<float>> points);

    std::vector<std::vector<float>> CreatePointCloudToVectorData(typename pcl::PointCloud<PointT>::Ptr cloud);
